...
export default function Pricing() {
  const plans = [
    ...
    {
      name: "Professional",
      description: "Ideal for growing tech teams and businesses",
      price: "$89",
      period: "/month",
      badge: "Most Popular",
      features: [
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed mb-8">
            Choose the perfect plan to accelerate your software development. 
        ...
        <div className="text-center mt-16 max-w-2xl mx-auto">
          ...
          <p className="text-muted-foreground mb-6">
            We create tailored software solutions for enterprises with unique technical requirements. 
            Let's discuss how QuickSolve can accelerate your digital transformation.
          </p>
